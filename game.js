...
function buildScript() {
  ...
  return [
    ...
    { c: 'memory', lines: [
      'こどもの ころだけじゃ、なかった。',
      '『デートか？　デート行くんか？　男か？』',
      '『お前、跡継ぎもできないどころか、何処でも雇って貰えんぞ』',
      '『子供を3人産みなさい。いないと老後が寂しいから』',
      '『私を老人ホームなんかに連れて行ったら、化けて出てきてやるからな』',
      'わたしの みらいは、ぜんぶ、あのひとの ものだった。',
    ] },
    ...
    { c: 'flash', color: '#fff', t: 10, sfx: 'slash' },
    { c: 'shake', t: 20, mag: 6 },
    { c: 'say', t: '怨念のなかから、声が、あふれだす。——ぜんぶ、ぜんぶ、おかあさんの声だ。' },
    ...
    { c: 'say', n: O, t: '「97点は、すごい。クズなんかじゃ、ぜんぜんない。ずっとひとりで耐えてきた分まで、君はえらかった」' },
