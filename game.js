  ...
  return [
    ...
    { c: 'free', until: 1080, triggers: [
      { x: 1010, run: [
        ...
        { c: 'say', n: K, t: '「ああ、ななしちゃん。その井戸はやめておけ。古い水の匂いがする」' },
    ...
    { c: 'free', until: 700, triggers: [
      { x: 620, run: [
        ...
        { c: 'say', n: K, t: '「ななしちゃん、石段は左側を登るのが作法でな」' },
    ...
    { c: 'say', n: K, t: '「ななしちゃん。この町を、どう思う」' },
    { c: 'say', n: N, t: '「……しずか。だれも、いない」' },
    { c: 'say', n: N, t: '「……すき、かも」' },
    { c: 'say', n: K, t: '「……そうか」' },
    { c: 'say', n: K, t: '「——ななしちゃん。帰りたい場所は、あるか」' },
    { c: 'choice', opts: [
      { t: '「ない」' },
      { t: '「……わからない」' },
    ] },
    ...
    { c: 'say', n: K, t: '「ななしちゃん、我から離れるな。……夢祀りの仕舞いだ」' },
    { c: 'fade', to: 1, t: 30 },
    ...
    { c: 'say', t: 'ななしちゃんの輪郭が、夜に、にじんで、ほどけて——' },
    ...
    { c: 'say', n: K, t: '「黙っていてすまなかったな、ななしちゃん。我の名は幽世——」' },
    ...
    { c: 'say', n: O, t: '「はじめまして——いや、ずっと隣を歩いてたから、はじめましてでも、ないんだけどね」' },
    { c: 'say', n: '名無死', t: '『チカヨルナ。カエラナイ。ワタシニハ ナニモナイ。ナマエモ ナイ』' },
    { c: 'say', n: O, t: '「名前が、ない？　——あるよ」' },
    ...
    { c: 'say', n: O, t: '「君はなにひとつ、わるくない。なにひとつだ。それだけは、神さまの僕が保証する」' },
